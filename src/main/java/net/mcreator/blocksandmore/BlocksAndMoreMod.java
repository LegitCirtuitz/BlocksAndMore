...
public class BlocksAndMoreMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(BlocksAndMoreMod.class);
	public static final String MODID = "blocks_and_more";
